package tr.org.liderahenk.firewall.commands;
...
public class FirewallCommand implements ICommand {

	private Logger logger = LoggerFactory.getLogger(FirewallCommand.class);
